...
public class Pesq1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pesq1);

        CheckBox checkBoxTucuruvi = findViewById(R.id.radioButton1); // exemplo de um CheckBox
