...
public class OrigemListAdapter extends ArrayAdapter<PercursoModel> {
    private Context mContext;
    private int mResource;

    public OrigemListAdapter(@NonNull Context context, int resource, @NonNull List<PercursoModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textViewContagemOrigem = convertView.findViewById(R.id.textViewContagemOrigem);

        // 4. Preencher os TextViews com os dados do objeto PercursoModel
        if (percurso != null) {
            textViewOrigem.setText("Origem: " + percurso.getOrigem());
            textViewContagemOrigem.setText("Contagem: " + percurso.getContagem());
        }
